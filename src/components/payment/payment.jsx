...
const Payment = () => {
  ...
  const descVoucher = async () => {
    const results = await descPayment(access_token);
    console.log(results, "ressaaaaa");
    if (results.success) {
      const payload = results.data.reduce((acc, curr) => {
        return [
  ...
  const ascVoucher = async () => {
    const results = await ascPayment(access_token);
    console.log(results, "ressaaaaa");
    if (results.success) {
      const payload = results.data.reduce((acc, curr) => {
        return [
  ...
  const onePreVoucher = async () => {
    ...
    const results = await onePreData(data, access_token);
    console.log(results, "ressaaaaa");
    if (results.success) {
      const payload = results.data.reduce((acc, curr) => {
        return [
  ...
  const oneNextVoucher = async () => {
    ...
    const results = await oneNextData(data, access_token);
    console.log(results, "ressaaaaa");
    if (results.success) {
      const payload = results.data.reduce((acc, curr) => {
        return [
